...
var details=[]; if(key)details.push('Route: /p/'+key); if(status)details.push('Upstream HTTP: '+status); q('.hcf-ex span').textContent=details.length?' // '+details.join(' // '):''; q('.hcf-ef span').textContent='Harley\'s Clan Forum // Flarum 1.x // Loader '+BUILD;
